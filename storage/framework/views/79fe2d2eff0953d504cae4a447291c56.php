...
<body class="bg-[#fef9e7] min-h-screen font-poppins text-gray-800 flex flex-col justify-center items-center px-4">
    ...
    <div class="text-center max-w-md">
        ...
        <p class="mb-2">Pesanan atas nama <strong><?php echo e($customer_name); ?></strong></p>
        <p class="mb-4">Total pembayaran: <strong>Rp<?php echo e(number_format($total_price, 0, ',', '.')); ?></strong></p>
...
<?php /**PATH C:\laragon\www\Website-pemesanan-seblak-lemaknyo\resources\views/thankyou_qris.blade.php ENDPATH**/ ?>